...
// Wire types for the 01flux WA API, split by domain into types_*.go files. Field
...
//
//	01flux-wa.DeleteMessageRequest{ChatID: id, MessageID: mid, ForEveryone: 01flux-wa.Ptr(false)}
