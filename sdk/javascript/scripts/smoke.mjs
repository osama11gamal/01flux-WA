...
if (typeof cjs.FluxWaClient !== 'function') throw new Error('CJS: FluxWaClient missing');

const esm = await import(new URL('../dist/esm/index.js', import.meta.url).href);
if (typeof esm.FluxWaClient !== 'function') throw new Error('ESM: FluxWaClient missing');
...
console.log('smoke OK: require() + import() both resolve FluxWaClient, and each condition types itself');
