...
def make_client(
    backend: MockBackend, base_url: str = "http://localhost:2785", api_key: str = "flx_k1_test"
) -> "FluxWaClient":
    from fluxwa import FluxWaClient

    return FluxWaClient(base_url=base_url, api_key=api_key, transport=backend.as_transport())
