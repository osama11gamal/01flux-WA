...
const distDir = join(mkdtempSync(join(tmpdir(), '01flux-wa-surface-')), 'dashboard', 'dist');
mkdirSync(distDir, { recursive: true });
writeFileSync(
  join(distDir, 'index.html'),
  `<!doctype html><html><head><meta name="01flux-wa-csp-nonce" content="${DASHBOARD_CSP_NONCE_PLACEHOLDER}" />` +
