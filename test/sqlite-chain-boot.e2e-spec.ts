...
const dataDb = join(tmpdir(), `01flux-wa-chain-${process.pid}.sqlite`);
const mainDb = join(tmpdir(), `01flux-wa-chain-main-${process.pid}.sqlite`);
const keyFile = join(tmpdir(), `01flux-wa-chain-key-${process.pid}`);
