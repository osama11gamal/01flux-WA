 ...
 * fills in by hand:
 *
 *   - 29.5.1/29.5.2 "01flux WA exposure" — which library symbol the adapters actually use.
 *   - 29.5.4 "01flux WA" — which library events the adapters actually subscribe to.
 *
