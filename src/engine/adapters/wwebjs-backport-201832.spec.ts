...
describe('patch-wwebjs-201832 (build-time backport of upstream #201832)', () => {
  ...
  it('applies the backport across every id-normalization site', () => {
    ...
    // Root helper + the load-bearing Message constructor that 01flux WA's ~40
    ...
    // from/to/author fallbacks (01flux WA reads these as chat/sender strings).
  ...
  it('normalizes a $1-only id while leaving a healthy id untouched', () => {
    ...
    // Sibling fields survive the copy — 01flux WA reads id.remote / id.id downstream.
