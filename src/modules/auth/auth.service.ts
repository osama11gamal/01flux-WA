 ...
 * cryptographically random `flx_k1_` key is generated — the secure default,
...
export function resolveSeedApiKey(): string {
  ...
  return `flx_k1_${randomBytes(32).toString('hex')}`;
}
...
export class AuthService implements OnModuleInit, OnModuleDestroy {
  ...
  async onModuleInit(): Promise<void> {
    ...
    this.logger.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    this.logger.log('');
    this.logger.log('  🟢 Welcome to 01flux WA - WhatsApp API Gateway');
    this.logger.log('');
  ...
  async createApiKey(dto: CreateApiKeyDto): Promise<{ apiKey: ApiKey; rawKey: string }> {
    // Generate secure random key: flx_k1_<32 bytes hex>
    const rawKey = `flx_k1_${randomBytes(32).toString('hex')}`;
    const keyHash = this.hashKey(rawKey);
    const keyPrefix = rawKey.substring(0, 12);
