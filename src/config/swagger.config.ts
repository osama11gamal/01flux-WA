...
/**
 * Builds the OpenAPI document configuration for the 01flux WA API.
 */
export function createSwaggerConfig(): Omit<OpenAPIObject, 'paths'> {
  ...
  return (
    new DocumentBuilder()
      ...
      .setContact('01flux WA', 'https://github.com/rmyndharis/01flux-wa', 'yudhi@rmyndharis.com')
