<p align="center">
  <img src="logo/flux_wa_logo.webp" alt="01flux WA Logo" width="200"/>
</p>

<h1 align="center">01flux WA Documentation</h1>
<p align="center">
...
| 22  | [n8n Integration](./22-n8n-integration.md)                               | n8n community nodes for 01flux WA                                                     |
| 23  | [Community Integrations](./23-community-integrations.md)                 | Third-party adapters built on the 01flux WA API                                       |
...
| [Webhook Signature Verification](./examples/webhook-signature-verification.md) | Verify signed 01flux WA webhook deliveries in Node.js and Python            |
| [n8n Appointment Booking Workflow](./examples/n8n-appointment-booking.md)      | Build an appointment-booking flow with 01flux WA and n8n                    |
...
01flux WA seeds a default API key on first run and writes it to:
...
random `flx_k1_...` admin key is generated on first run in all environments; set
...
curl -X POST http://localhost:2785/api/sessions/{sessionId}/messages/send-text \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{"chatId": "628123456789@c.us", "text": "Hello from 01flux WA!"}'
```
...
_01flux WA Documentation · Last updated: 2026-07-28_
