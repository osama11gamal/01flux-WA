...
```mermaid
timeline
    title 01flux WA Release Timeline
...
├── Docker image (ghcr.io/rmyndharis/01flux-wa:0.0.1)
├── docker-compose.yml
...
├── Docker image (ghcr.io/rmyndharis/01flux-wa:0.0.2)
...
├── Docker image (ghcr.io/rmyndharis/01flux-wa:0.1.0)
...
| ---------------------- | -------- | -------------------------------------------------- | ------------------------------- |
| JavaScript/Node.js SDK | P1       | ✅ Shipped (`@rmyndharis/01flux-wa`)                  | Official client library         |
| Python SDK             | P2       | ✅ Shipped (`rmyndharis-01flux-wa`)                   | Python client library           |
| PHP SDK                | P2       | ✅ Shipped (`rmyndharis/01flux-wa`)                   | PHP client library              |
| Java SDK               | P2       | ✅ Shipped (`com.rmyndharis:01flux-wa`)               | Java client library             |
| Go SDK                 | P2       | ✅ Shipped (`github.com/rmyndharis/01flux-wa/sdk/go`) | Go client library               |
...
| Feature                | Priority | Status                                      | Description                      |
| ---------------------- | -------- | ------------------------------------------- | -------------------------------- |
| Prometheus Metrics     | P1       | ✅ Shipped (`GET /api/metrics`, `FLUX_WA_*`) | /metrics endpoint for monitoring |
...
> [01flux WA-plugins](https://github.com/rmyndharis/01flux-wa-plugins) catalog, so consult that repository for
...
Then bump `appVersion` in `charts/01flux-wa/Chart.yaml` to the same version — the chart defaults its
...
git add package.json package-lock.json openapi.json CHANGELOG.md charts/01flux-wa/Chart.yaml SECURITY.md
...
docker buildx imagetools inspect ghcr.io/rmyndharis/01flux-wa:<version>
docker buildx imagetools inspect docker.io/rmyndharis/01flux-wa:latest
```
