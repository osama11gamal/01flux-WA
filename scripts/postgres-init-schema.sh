#!/bin/bash
# 01flux WA — built-in PostgreSQL schema init.
#
...
# already-initialized volume, create it manually once (e.g. `CREATE SCHEMA 01flux-wa;`) and set
# POSTGRES_SCHEMA on the 01flux-wa-api service.
set -euo pipefail
